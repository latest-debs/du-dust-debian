...
[![Release](https://img.shields.io/github/v/release/latest-debs/du-dust-debian)](https://github.com/latest-debs/du-dust-debian/releases)
[![Build](https://github.com/latest-debs/du-dust-debian/actions/workflows/release.yml/badge.svg)](../../actions)
...
```sh
sudo apt install ./du-dust_*.deb
```

## Verify

```sh
apt-cache policy du-dust
du-dust --version
```
...
For issues with du-dust itself, see
